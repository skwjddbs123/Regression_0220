...
menu0.url = "?menu=0"
menu0.tips = ["1.1 성적예측","1.2 당뇨 상태 예측","1.3 보스턴 주택가격 예측"]
menu1 = new Menu("2. 임시 메뉴")
menu1.url = "?menu=1"
menu1.tips = ["2.1 임시","2.2 임시","2.3 임시"] //로그인 로그아웃 기능
menu2 = new Menu("3. 임시 메뉴")
menu2.url = "?menu=2"
menu2.tips = ["3.1 임시","3.2 임시","3.3 임시","3.4 임시 ","3.5 임시","3.6 임시","3.7 임시"]
menu3 = new Menu("4. 임시")
menu3.url = "?menu=3"
